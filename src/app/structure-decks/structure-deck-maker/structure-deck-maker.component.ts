...
@Component({
  selector: 'app-structure-deck-maker',
  templateUrl: './structure-deck-maker.component.html',
  styleUrls: ['./structure-deck-maker.component.css']
})
export class StructureDeckMakerComponent implements OnInit {
  toolbar: Toolbar = [
    ['bold', 'italic'],
    ['underline', 'strike'],
    ['code', 'blockquote'],
