...
export class HoverCardComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    .subscribe((data:HoveredCardDetails) => {
      console.log(data);
      this.hoveredCard = data.card;
      this.leftPosition = data.leftPosition;
      this.rightPosition = data.rightPosition;
      this.isHovering = data.isHovering;
      this.reposition();
    });


    this.customcardService.disableHoverCardEvent
  ...
  reposition(){
    if(this.leftPosition>=920){
      ...
      else if(this.rightPosition<0){
        this.rightPosition+=50;
      }
      else if(this.rightPosition>300){
        this.rightPosition-=150;
      }
      else{
